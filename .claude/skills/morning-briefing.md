...
Produces a daily briefing saved to `briefings/YYYY-MM-DD.md`, covering research-relevant graphics/vision content and AI tooling news.
...
6. Commit the file with message: `briefing: YYYY-MM-DD`
